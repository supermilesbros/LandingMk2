...
import { renderToString } from 'file:///Users/jaredmiles/Documents/Clients/Recovery%20Room/LandingMk2/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///Users/jaredmiles/Documents/Clients/Recovery%20Room/LandingMk2/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/jaredmiles/Documents/Clients/Recovery%20Room/LandingMk2/node_modules/ofetch/dist/node.mjs';
...
import unstorage_47drivers_47fs from 'file:///Users/jaredmiles/Documents/Clients/Recovery%20Room/LandingMk2/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/jaredmiles/Documents/Clients/Recovery%20Room/LandingMk2/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file:///Users/jaredmiles/Documents/Clients/Recovery%20Room/LandingMk2/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/jaredmiles/Documents/Clients/Recovery%20Room/LandingMk2/node_modules/unhead/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "pwaManifest": {
      "name": "Proteam X Recovery Room",
      "short_name": "Proteam X Recovery Room",
      "description": "This is a simple form app for Proteam X Recovery Room.",
      "lang": "en",
      ...
      "icons": [
        {
          "src": "/_nuxt/icons/64x64.e609c607.png",
          "type": "image/png",
          "sizes": "64x64",
          "purpose": "any"
        },
        {
          "src": "/_nuxt/icons/64x64.maskable.e609c607.png",
          "type": "image/png",
          "sizes": "64x64",
          "purpose": "maskable"
        },
        {
          "src": "/_nuxt/icons/120x120.e609c607.png",
          "type": "image/png",
          "sizes": "120x120",
          "purpose": "any"
        },
        {
          "src": "/_nuxt/icons/120x120.maskable.e609c607.png",
          "type": "image/png",
          "sizes": "120x120",
          "purpose": "maskable"
        },
        {
          "src": "/_nuxt/icons/144x144.e609c607.png",
          "type": "image/png",
          "sizes": "144x144",
          "purpose": "any"
        },
        {
          "src": "/_nuxt/icons/144x144.maskable.e609c607.png",
          "type": "image/png",
          "sizes": "144x144",
          "purpose": "maskable"
        },
        {
          "src": "/_nuxt/icons/152x152.e609c607.png",
          "type": "image/png",
          "sizes": "152x152",
          "purpose": "any"
        },
        {
          "src": "/_nuxt/icons/152x152.maskable.e609c607.png",
          "type": "image/png",
          "sizes": "152x152",
          "purpose": "maskable"
        },
        {
          "src": "/_nuxt/icons/192x192.e609c607.png",
          "type": "image/png",
          "sizes": "192x192",
          "purpose": "any"
        },
        {
          "src": "/_nuxt/icons/192x192.maskable.e609c607.png",
          "type": "image/png",
          "sizes": "192x192",
          "purpose": "maskable"
        },
        {
          "src": "/_nuxt/icons/384x384.e609c607.png",
          "type": "image/png",
          "sizes": "384x384",
          "purpose": "any"
        },
        {
          "src": "/_nuxt/icons/384x384.maskable.e609c607.png",
          "type": "image/png",
          "sizes": "384x384",
          "purpose": "maskable"
        },
        {
          "src": "/_nuxt/icons/512x512.e609c607.png",
          "type": "image/png",
          "sizes": "512x512",
          "purpose": "any"
        },
        {
          "src": "/_nuxt/icons/512x512.maskable.e609c607.png",
          "type": "image/png",
          "sizes": "512x512",
          "purpose": "maskable"
        }
...
const serverAssets = [{"baseName":"server","dir":"/Users/jaredmiles/Documents/Clients/Recovery Room/LandingMk2/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/jaredmiles/Documents/Clients/Recovery Room/LandingMk2","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/jaredmiles/Documents/Clients/Recovery Room/LandingMk2/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/jaredmiles/Documents/Clients/Recovery Room/LandingMk2/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/jaredmiles/Documents/Clients/Recovery Room/LandingMk2/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/jaredmiles/Documents/Clients/Recovery Room/LandingMk2/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _x4lkl278rw = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const _rYO4GhmOD9 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _n8YR1u = defineEventHandler(() => useRuntimeConfig().public.pwaManifest);

const _lazy_Zy2RQ1 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_Zy2RQ1, lazy: true, middleware: false, method: undefined },
  { route: '/manifest.json', handler: _n8YR1u, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_Zy2RQ1, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"hid":"description","name":"description","content":"This is a simple form app for Proteam X Recovery Room."},{"property":"og:site_name","content":"Proteam X Recovery Room"},{"hid":"og:type","property":"og:type","content":"website"},{"hid":"og:url","property":"og:url","content":""},{"hid":"og:image:secure_url","property":"og:image:secure_url","content":""},{"hid":"og:title","property":"og:title","content":"Proteam X Recovery Room"},{"hid":"og:description","property":"og:description","content":"This is a simple form app for Proteam X Recovery Room."},{"hid":"og:image","property":"og:image","content":""},{"name":"twitter:card","content":"summary_large_image"},{"hid":"twitter:url","name":"twitter:url","content":""},{"hid":"twitter:title","name":"twitter:title","content":"Proteam X Recovery Room"},{"hid":"twitter:description","name":"twitter:description","content":"This is a simple form app for Proteam X Recovery Room."},{"hid":"twitter:image","name":"twitter:image","content":""},{"name":"mobile-web-app-capable","content":"yes","key":"mobile-web-app-capable"},{"name":"apple-mobile-web-app-title","content":"Proteam X Recovery Room","key":"apple-mobile-web-app-title"},{"name":"author","content":"Behon Baker","key":"author"},{"name":"description","content":"This is a simple form app for Proteam X Recovery Room.","key":"description"},{"name":"theme-color","content":"#4f46e5","key":"theme-color"},{"property":"og:type","content":"website","key":"og:type"},{"property":"og:title","content":"Proteam X Recovery Room","key":"og:title"},{"property":"og:site_name","content":"Proteam X Recovery Room","key":"og:site_name"},{"property":"og:description","content":"This is a simple form app for Proteam X Recovery Room.","key":"og:description"},{"name":"twitter:card","content":"summary","key":"twitter:card"}],"link":[{"rel":"stylesheet","href":"https://rsms.me/inter/inter.css"},{"rel":"preconnect","href":"https://rsms.me/"},{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"},{"rel":"canonical","href":""},{"rel":"icon","href":"/_nuxt/icons/64x64.e609c607.png","key":"favicon"},{"rel":"apple-touch-icon","href":"/_nuxt/icons/512x512.maskable.e609c607.png","sizes":"512x512","key":"favicon-apple"},{"rel":"manifest","href":"/manifest.json"}],"style":[],"script":[],"noscript":[],"title":"Proteam X Recovery Room","titleTemplate":"%s | Proteam X Recovery Room","htmlAttrs":{"lang":"en"}};
...
const getClientManifest = () => import('file:///Users/jaredmiles/Documents/Clients/Recovery%20Room/LandingMk2/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/jaredmiles/Documents/Clients/Recovery%20Room/LandingMk2/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
